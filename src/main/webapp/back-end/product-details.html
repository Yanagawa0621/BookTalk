                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="main_menu menu_center menu_position"> 
                                <nav>  
                                    <ul>
                                        <li style="margin: 0;"><a href="index-2.html">首頁</a></li>
                                        <li class="mega_items" style="margin: 0;" ><a class="active" href="shop.html">書籍商城</a></li>
                    ...
                    <div class="product_d_inner">   
                        <div class="product_info_button">    
                            <ul class="nav" role="tablist">
                                <li >
                                    <a class="active" data-toggle="tab" href="#info" role="tab" aria-controls="info" aria-selected="false">書籍介紹</a>
                                </li>
                                <li>
                                     <a data-toggle="tab" href="#sheet" role="tab" aria-controls="sheet" aria-selected="false">書籍規格</a>
                                </li>
                                <li>
                                   <a data-toggle="tab" href="#reviews" role="tab" aria-controls="reviews" aria-selected="false">評論</a>
                                </li>
                            </ul>
                        </div>
