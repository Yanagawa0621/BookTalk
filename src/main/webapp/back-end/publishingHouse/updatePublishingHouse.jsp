			...
			<div class="content">
				...
				<div class="card">
	              <div class="card-header">
	                <h3 class="card-title">編號:${phVO.publishingHouseNumber}</h3>
	              </div>	<!-- /.card-header -->
	              <div class="card-body">
		                ...
		                <table id="updateOrder" class="table table-bordered table-hover">
		                	<tbody>
		                		<tr>
		                			...
		                			<td>
			                			<input class="form-control" type="text" name="name" value="${phVO.name}" required>
		                		...
		                		<tr>
		                			...
		                			<td>
			                			<input class="form-control" type="text" name="address" placeholder="111台北市士林區中山北路七段14巷72-74號" value="${phVO.address}" required>
			                			<div class="invalid-tooltip">
		          							地址請勿空白         							
		        						</div>
		                			</td>
		                		...
		                		<tr>
		                			...
		                			<td>
			                			<input class="form-control" type="text" name="personInCharge" value="${phVO.personInCharge}" required>
			                			<div class="invalid-tooltip">
		          							負責人請勿空白         							
		        						</div>
		                			</td>
		                		...
		                		<tr>		                			
		                			...
		                			<td>
			                			<input class="form-control" type="text" placeholder="範例:02-12345678(若有分機請加-xxx),手機為:0912345678" name="telephoneNumber" value="${phVO.telephoneNumber}" required>
			                			<div class="invalid-tooltip">
		          							電話請勿空白         							
		        						</div>
		                			</td>
