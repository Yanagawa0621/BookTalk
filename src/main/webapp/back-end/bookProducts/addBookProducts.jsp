						...
						<form id="bookForm" method="post" 
												...
												<select name="publishiingHouseCode" class="form-control">
													<c:forEach var="phVO" items="${phList}">
														<option value="${phVO.publishingHouseNumber}"
															<c:if test="${bpVO != null && phVO.publishingHouseNumber == bpVO.phVO.publishingHouseNumber}">selected</c:if>>${phVO.name}</option>
													</c:forEach>
												</select>
											</div>
										</td>
											...
											<div class="input-group" style="width: 20%">
												...
												<div class="input-group date" id="reservationdatetime"
													...
													<input type="text" name="publicationDate"
														...
														value="<%=(bpVO == null) ? "" : bpVO.getPublicationDate()%>" />
								...
								<tr>
									...
									<td><textarea name="introductionContent"
											class="form-control" style="width: 50%;"><c:out
												value="${bpVO == null ? '' : bpVO.getIntroductionContent()}" /></textarea>
									</td>
								</tr>
								</tbody>
							</table>
							<div class="row">
								<div class="col-md-1 offset-md-10">
									...
									<button type="submit"
										class="btn btn-block bg-gradient-primary btn">送出新增</button>
								</div>
								<div class="col-md-1">
									<a
