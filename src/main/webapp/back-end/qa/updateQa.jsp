			...
			<div class="content">
				...
				<div class="card">
	              <div class="card-header">
	                <h3 class="card-title">問題編號:${vo.questionNo}</h3>
	              </div>	<!-- /.card-header -->
	              <div class="card-body">
		              <form method="post" name="updateOrderForm" action="${pageContext.request.contextPath}/qaBack.do" class="needs-validation" novalidate>
