...
<%
	String str = request.getParameter("articleNumber");
	Integer articleNumber=null;
	try{
		articleNumber = Integer.parseInt(str);
			...
			<div class="row row-editor">
				<div class="editor-container" style="padding:32px;">
					<form class="thisforum" action="<%=request.getContextPath()%>/article/article.do" method="post"  onsubmit="return validateForm()">
						看板:${articleVO.forumVO.name}
						作者:${sessionScope.userNumber}
						<br>
						標題:
						<input type="text" name = "title" value="${articleVO.title}"required style="width:94.5%; height:30px;">
