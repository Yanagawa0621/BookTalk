	                                ...
	                                <figcaption class="blog_content">
	                                   ...
	                                   <!-- Modal -->
	                                    ...
	                                    <c:set var="userName" value="${userVO.getUserByNumber(ArticleUserNumber)}"/>
	                                        <p>作者: ${userName.name} / 發文日期: ${articleVO.issueTime} / 看板: ${forumVO.name}</p>
	                                    </div>
                    	...
                    	<div class="widget_list widget_search">
                            <div class="widget_title">
                             ...
                             <c:if test="${not empty forumVO}">
						       <form onsubmit="handleFormSubmit(event, <%= forumVO.getForumNumber() %>)">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="pagination">
                        <ul>
                        	<%@include file="/front-end/article/page3.file" %>
...
function handleFormSubmit(event,forumNumber) {
    event.preventDefault(); // 阻止默认的表单提交

    if (userID) {
        // 如果 userID 有值，直接跳转到a网址
        window.location.href = contextPath + "/front-end/article/ckEditor/sample/addArticle.jsp?forumNumber="+forumNumber;
    } else {
